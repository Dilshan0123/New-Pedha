class MS_DataModel {
  ...
  MS_DataModel({this.status, this.message, this.data, this.statusCode});

  MS_DataModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    urnId = json['urnId'];
    if (json['miniStatementStructureModel'] != null) {
      miniStatementStructureModel = <MiniStatementStructureModel>[];
      json['miniStatementStructureModel'].forEach((v) {
        miniStatementStructureModel!
            .add(MiniStatementStructureModel.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['urnId'] = urnId;
    if (miniStatementStructureModel != null) {
      data['miniStatementStructureModel'] =
          miniStatementStructureModel!.map((v) => v.toJson()).toList();
    }
...
class MiniStatementStructureModel {
  ...
  MiniStatementStructureModel(
      {this.date, this.txnType, this.amount, this.narration});

  MiniStatementStructureModel.fromJson(Map<String, dynamic> json) {
    date = json['date'];
