...
class bbpsDataModel {
  ...
  bbpsDataModel.fromJson(Map<String, dynamic> json) {
  ...
  static List<bbpsDataModel> parseList(dynamic json) {
    if (json.toString().isNotEmpty) {
      return json
          .map<bbpsDataModel>(
              (tagJson) => bbpsDataModel.fromJson(tagJson))
          .toList();
    } else {
      return <bbpsDataModel>[];
    }
  }
}